...
for run in experiment_num:
    for i in range(sub_start, sub_end+1):
        ...
        os.makedirs('D:\\AI_CW_Merge\\New_Generated\\Experiment_'+str(run)+'_new_image_output_'+str(sub_start)+'-'+str(sub_end)+'\\subject_' + str(i) + '\\')
        #     From 0 to 64
        ...
        for j in range(13):
            ...
            os.makedirs('D:\\AI_CW_Merge\\New_Generated\\Experiment_'+str(run)+'_new_image_output_'+str(sub_start)+'-'+str(sub_end)+'\\subject_' + str(i) + '\\channel_' + str(j) + "\\")
            for segment in range(12):
                ...
                plt.axis('off')
                plt.show()
                plt.savefig("D:\\AI_CW_Merge\\New_Generated\\Experiment_"+str(run)+"_new_image_output_"+str(sub_start)+"-"+str(sub_end)+"\\subject_" + str(i) + "\\channel_" + str(j) + "\\example_" + str(
